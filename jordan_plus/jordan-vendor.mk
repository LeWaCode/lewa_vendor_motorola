...
PRODUCT_COPY_FILES += \
	...
	vendor/motorola/jordan_plus/lib/libOMX.TI.JPEG.Encoder.so:system/lib/libOMX.TI.JPEG.Encoder.so \
		vendor/motorola/jordan_plus/lib/libOMX.TI.JPEG.decoder.so:system/lib/libOMX.TI.JPEG.decoder.so \
	vendor/motorola/jordan_plus/lib/libOMX.TI.mp4.splt.Encoder.so:system/lib/libOMX.TI.mp4.splt.Encoder.so \
	vendor/motorola/jordan_plus/lib/libOMX.TI.VPP.so:system/lib/libOMX.TI.VPP.so \
...
# copy all others basebands under the "basebands" directory to system/etc/basebands
PRODUCT_COPY_FILES += $(shell test -d vendor/motorola/jordan_plus/etc/motorola/basebands/america && \
	find vendor/motorola/jordan_plus/etc/motorola/basebands/america -name '*.zip' \
	-printf '%p:system/etc/motorola/basebands/america/%f ')
	
PRODUCT_COPY_FILES += $(shell test -d vendor/motorola/jordan_plus/etc/motorola/basebands/asia && \
	find vendor/motorola/jordan_plus/etc/motorola/basebands/asia -name '*.zip' \
	-printf '%p:system/etc/motorola/basebands/asia/%f ')

PRODUCT_COPY_FILES += $(shell test -d vendor/motorola/jordan_plus/etc/motorola/basebands/australia && \
	find vendor/motorola/jordan_plus/etc/motorola/basebands/australia -name '*.zip' \
	-printf '%p:system/etc/motorola/basebands/australia/%f ')

PRODUCT_COPY_FILES += $(shell test -d vendor/motorola/jordan_plus/etc/motorola/basebands/europe && \
	find vendor/motorola/jordan_plus/etc/motorola/basebands/europe -name '*.zip' \
	-printf '%p:system/etc/motorola/basebands/europe/%f ')
